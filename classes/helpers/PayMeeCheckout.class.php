...
require_once("classes/models/enums/CheckoutType.class.php");
require_once("classes/models/enums/PaymentMethod.class.php");
class PayMeeCheckout {
    ...
    public function create($checkoutType, $toJSON) {
        ...
        } elseif(!isset($this->config["shopper"]) || (isset($this->config["shopper"]) && !is_a($this->config["shopper"], 'PayMee\Shopper'))) {
